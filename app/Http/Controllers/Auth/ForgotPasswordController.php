...
';
        ...
        $email=$request->email;
        $request->session()->flash('successMsg','If the email entered is associated with a Connect Social account, you will receive an email with password reset instructions.');
