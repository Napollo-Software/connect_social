                ...
                <div class="profile-navigation-ul-outer">
                    <div class="profile-navigation-ul-box to-show-menu-01">
                        <ul class="profile-navigation-ul">
                            ...
                            <li class="profile-navigation-li {{in_array(Route::currentRouteName(),['friends.show','connections.show'])?'active':''}}" ><a href="{{route('network',['type'=>'friend'])}}" class="profile-navigation-link">Networks({{getFriendsList($user->id)->count()}})</a></li>
                        </ul>
                    </div>
