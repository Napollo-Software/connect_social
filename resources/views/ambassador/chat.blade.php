                                ...
                                <form id="message-send-form">
                                    ...
                                    <div class="sned-message-chat">
                                        ...
                                        <div class="send-message-input-outer">
                                            <input type="text" id="message" name="message" class="form-control send-message-input">
                                        </div>
                                        <div class="send-message-button">
                                            <button class="black-button  btn-msg-send" id="btn-msg-send" type="submit">Send</button>
                                        </div>
                                    </div>
                                </form>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (i, v) {
                            user_container.append('<div class="chat-contacts-single user-of-chat-list" data-id="' + v['id'] + '"><div class="chat-contacts-single-inner"><div class="chat-contacts-single-info"><div class="chat-contacts-single-image"><img src="' + v['src'] + '" alt=""></div><div class="chat-contacts-single-name-message"><div class="chat-contacts-single-name">' + v['name'] + '</div><div class="chat-contacts-single-message"></div></div></div><div class="chat-contacts-single-time"><span class="time"></span></div></div></div>');
                        });
                    },
                    error: function (xhr) {
