        ...
        <div class="home-navigation-inner">
            <div class="home-navigation-nav">
                ...
                <li class="home-navigation-li {{Route::currentRouteName()=='home'?'active':''}}  {{Route::getCurrentRoute()->type=='all'?'active':''}}"><a href="{{url('home/all')}}" class="home-navigation-link"><span class="icon"><img src="{{asset('ambassador_assets/images/icons/globe.svg')}}" alt=""></span> <span class="text">Everyone</span></a></li>
                    ...
                    <li class="home-navigation-li {{Route::getCurrentRoute()->type=='tier-2'?'active':''}}"><a href="{{url('home/tier-2')}}" class="home-navigation-link"><span class="icon"><img src="{{asset('ambassador_assets/images/icons/extended-network.svg')}}" alt=""></span> <span class="text">Extended Network</span></a></li>
                </ul>
